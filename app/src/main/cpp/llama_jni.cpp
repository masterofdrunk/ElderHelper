// Adapted from OpenBMB/MiniCPM-V-Apps Android demo at commit
// e045745746f9a304592edc692dfeb0da5c5dac7d
// (llama.cpp-omni submodule da241979b95b13e747f7c3f8d6821930e0263d33).
// JNI symbols are renamed for ElderHelper and prompt logging is redacted.
...
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_init(JNIEnv *env, jobject /*unused*/, jstring nativeLibDir) {
...
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_load(JNIEnv *env, jobject, jstring jmodel_path) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_loadMmproj(JNIEnv *env, jobject,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_getMinicpmvVersionNative(JNIEnv * /*env*/, jobject) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_setMinicpmvVersionNative(JNIEnv * /*env*/,
                                                                      jobject,
                                                                      jint jversion) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_setImageMaxSliceNumsNative(JNIEnv * /*env*/,
                                                                        jobject,
                                                                        jint jn) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_prepare(JNIEnv * /*env*/, jobject /*unused*/) {
...
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_systemInfo(JNIEnv *env, jobject /*unused*/) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_processSystemPrompt(
        JNIEnv *env,
        jobject /*unused*/,
    ...
    LOGd("%s: System prompt received (%zu bytes)", __func__, std::strlen(system_prompt));
    std::string formatted_system_prompt(system_prompt);

    const bool has_chat_template = common_chat_templates_was_explicit(g_chat_templates.get());
    if (g_ctx_vision) {
        // MiniCPM-V's template requires a user query when formatted through
        // common_chat_format_single(). For the MTMD vision path, format the
        // system turn explicitly and keep user turns on the same manual path
        // used below in processUserPrompt().
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_prefillImage(
        JNIEnv *env,
        jobject /*unused*/,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_fullReset(JNIEnv *, jobject) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_nativeCancelGeneration(JNIEnv *, jobject) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_processUserPrompt(
        JNIEnv *env,
        jobject /*unused*/,
    ...
    LOGd("%s: User prompt received (%zu bytes)", __func__, std::strlen(user_prompt));
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_generateNextToken(
        JNIEnv *env,
        jobject /*unused*/
) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_unload(JNIEnv * /*env*/, jobject /*unused*/) {
    reset_long_term_states();
    reset_short_term_states();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_elderhelper_analyzer_NativeMiniCpmBridge_shutdown(JNIEnv *, jobject /*unused*/) {
    llama_backend_free();
}
